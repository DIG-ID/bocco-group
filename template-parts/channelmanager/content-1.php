	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-12 col-md-12 col-lg-6 col-xl-6 section-cmcontent-1__leftcol">
				<div class="section-cmcontent-1__img-pack" data-animate="fade-left" data-animate-stagger="0.15">
					<img src="<?php echo esc_url( wp_upload_dir()['url'] . '/CM_A_1.png' ); ?>" data-animate-child>
					<img class="section-cmcontent-1__img-abtop" src="<?php echo esc_url( wp_upload_dir()['url'] . '/CM_A_2.png' ); ?>" data-animate-child>
					<img class="section-cmcontent-1__img-abbot" src="<?php echo esc_url( wp_upload_dir()['url'] . '/CM_A_3.png' ); ?>" data-animate-child>
				</div>
			</div>
