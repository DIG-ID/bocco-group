	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-12 col-md-12 col-lg-6 col-xl-6 section-servicescontent-1__leftcol">
				<div class="section-servicescontent-1__content-wrapper" data-animate="fade-left" data-animate-stagger="0.15">
					<p class="section-servicescontent-1__subtitle" data-animate-child><?php the_field( 'set_up_subtitle' ); ?></p>
					<h1 class="section-servicescontent-1__title" data-animate-child><?php the_field( 'set_up_title' ); ?></h1>
					<p class="section-servicescontent-1__text" data-animate-child><?php the_field( 'set_up_description' ); ?></p>
					<ul class="section-servicescontent-1__list" data-animate-child>
						<?php
